  ...
  return (
    <Sonner
      ...
      toastOptions={{
        classNames: {
          toast:
            "group toast group-[.toaster]:bg-white/10 group-[.toaster]:backdrop-blur-md group-[.toaster]:border group-[.toaster]:border-white/20 group-[.toaster]:shadow-lg group-[.toaster]:rounded-lg text-base transition-all duration-200 hover:group-[.toaster]:bg-white/15",
